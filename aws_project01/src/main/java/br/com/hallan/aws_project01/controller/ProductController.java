package br.com.hallan.aws_project01.controller;

import br.com.hallan.aws_project01.enums.EventType;
import br.com.hallan.aws_project01.model.Product;
import br.com.hallan.aws_project01.repository.ProductRepository;
import br.com.hallan.aws_project01.service.ProductPublisher;
...
public class ProductController {
    ...
    public ResponseEntity<Product> saveProduct(@RequestBody @Valid Product product) {
        ...
        productPublisher.publishProductEvent(productSave, EventType.PRODUCT_CREATED, "matilde");
        return new ResponseEntity<Product>(productSave,
                HttpStatus.CREATED);
    }
